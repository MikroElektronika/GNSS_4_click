...
We provide a library for the GNSS4 Click on our [LibStock](https://libstock.mikroe.com/projects/view/2028/gnss-4-click) 
...
- ``` gnss4_cmdSingle ``` - Sends provided command to the module
- ``` gnss4_setHandler ``` - Handler assignation to the provied command
- ``` gnss4_modulePower ``` - Turn on module
...
[LibStock](https://libstock.mikroe.com/projects/view/2028/gnss-4-click) page.
